/*
	...
	besj0(x) returns the value of J0(x)
...
double
besy0(arg) double arg;{
	double argsq, n, d;
	double sin(), cos(), sqrt(), log(), besj0();
	int i;
	...
	return(n/d + tpi*besj0(arg)*log(arg));
}
