...
int	emulate = FALSE;		/* TRUE if devname != realdev */
...
char	downloaded[MAXCH+32];		/* status of charlib characters */
...
char	*optnames = "a:c:e:m:n:o:p:tw:x:y:A:BC:J:F:H:L:OP:R:S:T:DI";
 ...
 */
	...
	case 'T':			/* device name - set emulating here */
		fscanf(fp, "%s", devname);
		emulate = strcmp(devname, realdev) ? TRUE : FALSE;
		break;
