...
#define	N_COMMENT	8
#define	N_DEFINE	9
#define	N_SOURCE	10	/* insert a file without processing monk cmds */
#define	MAKE_COMMANDS	11	/* commands which find document type >= 11 */
#define	N_INSERT	11	/* insert a file processing monk commands */
#define	N_MAKE		12	/* specify document type */
#define	N_PART		13	/* specify parent */
