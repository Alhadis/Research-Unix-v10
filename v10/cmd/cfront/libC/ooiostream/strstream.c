/*ident	"@(#)ctrans:lib/stream/strstream.c	1.1.4.2" */
/**************************************************************************
...
streampos strstreambuf::seekoff(streamoff o, seek_dir d, open_mode m)
{
	switch (d) {
	case seek_beg : break ;
	case seek_cur : {
...
static char* pstart(char* str, int size, open_mode m)
{
...
ostrstream::ostrstream(char* str, int size, open_mode m)
...
strstream::strstream(char* str, int size, open_mode m) 
