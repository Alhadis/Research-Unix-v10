/* -*- Mode:C++ -*- */
/*ident	"@(#)ctrans:src/typ2.c	1.1.5.15" */
/*
	$Source: /usr3/lang/benson/work/stripped_cfront/RCS/typ2.c,v $ $RCSfile: typ2.c,v $
	$Revision: 1.1 $		$Date: 89/11/20 08:51:09 $
...
//error('d',"zx %t %d",t,t->base);
	...
	case RPTR:	
	case PTR:
	{	int k = (Pptr(t)->memof)?sizeof(short)+sizeof(short):0;
		t = Pptr(t)->typ;
	xxx:
		switch (t->base) {
...
/* ODI notes
   ...
   turn on DEFINED for predefined types to control tree copying
