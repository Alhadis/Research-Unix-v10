	...
	register struct symtab *sp;
{
	 ...
	 *
	 * the code above and comment below was written by someone
	 * who needs a little more experience in the real world.
	 * if you wish to do big .aligns, please do so; beware
	 * what the loader will do, but so what?
	 */
	if (   (xp->e_xtype != XABS)
	    || (xp->e_xvalue < 0)
	    || (xp->e_xvalue > 16)
