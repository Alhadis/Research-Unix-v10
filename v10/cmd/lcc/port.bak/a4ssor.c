/* a4ssor.f -- translated by f2c (version of 5 February 1993  1:37:14).
...
logical a4ssor_(wv, rv, iv, lv, errare)
real *wv, *rv;
integer *iv;
logical *lv;
real *errare;
{
    ...
    extern logical a4ssod_(), a4ssol_();
...
/* SEE IF A RE-START IS NECESSARY. */
    ...
    temp5 = iv[22];
    temp4 = iv[10];
    if (! a4ssol_(&rs[temp6 - 1], &rs[temp5 - 1], &iv[1], &iv[18], &iv[2], &
	    rs[temp4 - 1], &rv[10])) {
	goto L3;
    }
    ret_val = TRUE_;
...
L3:
    ...
    temp6 = iv[26];
    temp7 = iv[10];
    lv[6] = a4ssod_(&rs[temp4 - 1], &iv[1], &iv[18], &iv[3], &iv[2], &ws[
...
/* SEE IF A RE-START WOULD BE MORE EFFICIENT. */
    ...
    temp2 = iv[9];
    temp1 = iv[5];
    a4ssoo_(&rs[temp7 - 1], &iv[1], &iv[18], &iv[3], &iv[2], &ws[temp6 - 1], &
