/* a8xtrd.f -- translated by f2c (version of 5 February 1993  1:37:14).
...
logical a8xtrd_(e, nx, m, mmax, kmax, logn, beta, gamma, delta, f, pow, ldone,
	 ildone, kopto)
real *e;
integer *nx, *m, *mmax, *kmax;
real *logn, *beta, *gamma, *delta, *f, *pow;
...
/*  A8XTRD = .TRUE. IF WILL NOT CONVERGE IN THIS LOZENGE. */
/*  A8XTRD = .FALSE. IF WILL CONVERGE. */
