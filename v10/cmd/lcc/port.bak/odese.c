/* odese.f -- translated by f2c (version of 5 February 1993  1:37:14).
...
logical odese_(x, nx, t, dt, errpar, erputs, e)
real *x;
integer *nx;
real *t, *dt, *errpar;
logical *erputs;
...
/*  STANDARD ERROR ROUTINE FOR ODES WITH THE OPTION FOR ERROR CONTROL */
...
/*             PROPORTIONAL TO ABS(DT). OTHERWISE IT WILL NOT. */
...
/*    ODESE - .TRUE. IF EACH X(I) IS ACCURATE TO WITHIN AN */
