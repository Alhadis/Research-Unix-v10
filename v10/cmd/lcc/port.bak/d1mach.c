/* d1mach.f -- translated by f2c (version of 5 February 1993  1:37:14).
...
integer *i;
{
	...
	integer e_1[10];
	doublereal e_2;
	} equiv_4 = { 128, 0, -32769, -1, 9344, 0, 9472, 0, 546979738, 
		-805796613, 0. };
...
/* /7S */
    if (*i < 1 || *i > 5) {
	seterr_("D1MACH - I OUT OF BOUNDS", &c__24, &c__1, &c__2, 24L);
    }
/* / */
