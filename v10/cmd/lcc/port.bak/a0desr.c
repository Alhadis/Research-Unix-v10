/* a0desr.f -- translated by f2c (version of 5 February 1993  1:37:14).
...
/* Subroutine */ int a0desr_(t0, x0, t1, x1, nx, nt, f, ftx, xl, ftx0, igmax)
real *t0, *x0, *t1, *x1;
integer *nx, *nt;
/* Subroutine */ int (*f) ();
real *ftx, *xl, *ftx0;
...
/* ... SMOOTH AT THE END POINT. */
    ...
    for (i = 1; i <= i__1; ++i) {
/* L40: */
	x1[i] = (x1[i] + (xl[i] + dt2 * ftx[i])) * (float).5;
    }
