/* d4ssod.f -- translated by f2c (version of 5 February 1993  1:37:14).
...
logical d4ssod_(e, nx, m, mmax, kmax, slogn, beta, gamma, delta, f, pow, 
	ldone, ildone, kopto)
real *e;
integer *nx, *m, *mmax, *kmax;
doublereal *slogn, *beta, *gamma, *delta;
real *f, *pow;
...
/* D4SSOD = TRUE IF WILL NOT CONVERGE IN THIS LOZENGE. */
/* D4SSOD = FALSE IF WILL CONVERGE. */
    ret_val = TRUE_;
