/* dodes1.f -- translated by f2c (version of 5 February 1993  1:37:14).
...
/* Subroutine */ int dodes1_(f, x, nx, tstart, tstop, dt, error, errpar, 
...
/*               ERRPAR - TWO PARAMETERS, AS GIVEN TO DODES1. */
...
/*         11*NX + MAX ( 10 DOUBLE PRECISION + 10 , S(ERROR) ) , */
...
/*    8 - CANNOT RAISE DT IN HANDLE WHEN .NOT.OKAY. */
    ...
    dodes2_(f, &x[1], nx, tstart, tstop, dt, error, &errpar[1], handle, 
	    glbmax, erputs, &c__10, &c__16);
