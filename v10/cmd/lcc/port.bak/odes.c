/* odes.f -- translated by f2c (version of 5 February 1993  1:37:14).
...
/* Subroutine */ int odes_(f, x, nx, tstart, tstop, dt, errpar, handle)
/* Subroutine */ int (*f) ();
real *x;
integer *nx;
real *tstart, *tstop, *dt, *errpar;
/* Subroutine */ int (*handle) ();
{
    extern /* Subroutine */ int odes1_();
    extern /* Subroutine */ int odese_();
...
/*    8 - CANNOT RAISE DT IN HANDLE WHEN .NOT.OKAY. */
    ...
    odes1_(f, &x[1], nx, tstart, tstop, dt, odese_, &errpar[1], handle, &c__0,
	     &c__0);
