...
char *cpp[] = { "/usr/v8/lib/gcc-cpp", "-undef", "-Dsun", "-Dmc68000", "-Dmc68020", "$1", "$2", "$3", 0 };
char *include[] = { "-I/usr/v8/include", "-I/usr/v8/include/lcc", 0 };
char *com[] = { "/usr/v8/lib/rcc", "$1", "$2", "$3", 0 };
