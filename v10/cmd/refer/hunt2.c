...
if (colevel>0)
	{
	prevdrop.a=(unsigned *) zalloc(lmaster,iflong?sizeof(long):sizeof(int));
...
if (colevel)
	{
	free(prevdrop.a, lmaster, iflong?sizeof(long):sizeof(short));
