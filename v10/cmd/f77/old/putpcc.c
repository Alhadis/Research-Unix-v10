...
#include "pccdefs"
Addrp realpart();
LOCAL Addrp intdouble(), putcall(), putch1(), putcx1(), putcxeq();
LOCAL putaddr(), putcat(), putchcmp(), putcheq(), putchop(),
putcomma(), putct1(), putcxcmp(), putcxop(), putmem(),
putmnmx(), putop(), putpower();
expptr imagpart();
ftnint lencat();
