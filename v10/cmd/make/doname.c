static char *sccsid = "@(#)doname.c	8th edition (Bell Labs) 85/07/16";
#include "defs"
...
register depblkp q;
depblkp qtemp, srchdir(), suffp, suffp1;
nameblkp p1, p2, chkname();
struct shblock *implcom, *explcom;
register lineblkp lp;
lineblkp lp1, lp2;
char sourcename[100], prefix[100], temp[100], concsuff[20];
char *wildsub(), *wildmatch(), *stem;
char *pnamep, *p1namep;
char *mkqlist();
chainp allchain, qchain, appendq();
...
docom1(comstring, nohalt, noprint, doit, nowait)
register char *comstring;
int nohalt, noprint, doit, nowait;
{
register int status;
char *prefix;
