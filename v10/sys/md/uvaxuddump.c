 ...
 * on a disk attached to a KDA50 or RQDXn on a MicroVAX II
...
#define	UBMAP	((long *)0x20088000)	/* Q-bus map */
#define	UBREG	(0x20000000-0760000)	/* addr 0 in Q-bus space */
#define	UDA	((struct device *)(0772150+UBREG))
#define	ICR	(*(short *)0x20001f40)
#define	LMEAE	040			/* allow DMA */
