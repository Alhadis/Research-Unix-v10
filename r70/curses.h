...
#define crmode() (_tty.sg_flags |= CBREAK, _rawmode = TRUE, ioctl(_tty_ch, TIOCSETP,&_tty))
#define nocrmode() (_tty.sg_flags &= ~CBREAK,_rawmode=FALSE,ioctl(_tty_ch, TIOCSETP,&_tty))
...
#define	resetty() (_tty.sg_flags = _res_flg, ioctl(_tty_ch, TIOCSETP, &_tty))
