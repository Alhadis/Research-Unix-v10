...
#define grade(_x)  printf("g %g\n", _x)
#define idle()
#define line(_x1,_y1,_x2,_y2)  printf("li %g %g %g %g\n", _x1,_y1,_x2,_y2)
...
#define point(_x,_y)  printf("poi %g %g\n", _x,_y)
...
#define rvec(_x,_y)  printf("rv %g %g\n", _x,_y)
