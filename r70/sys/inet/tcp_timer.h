...
/*
 * add 1 to min val, to avoid spurious timeouts
 * due to quantization errors (timer set to 1 just before it ticks)
 */
#define	TCPTV_MIN	(  1*PR_SLOWHZ + 1)	/* minimum allowable value */
