...
typedef SIG_FUNC_TYP*	SIG_TYP;	// obsolescent?
typedef SIG_FUNC_TYP*	SIG_PF;
#ifndef KERNEL
extern "C" {
	SIG_FUNC_TYP* signal(int, SIG_FUNC_TYP*);
}
#endif

#define	BADSIG		(SIG_FUNC_TYP*)-1
#define	SIG_DFL		(SIG_FUNC_TYP*)0
#define	SIG_IGN		(SIG_FUNC_TYP*)1
#ifdef KERNEL
#define	SIG_CATCH	(SIG_FUNC_TYP*)2
#endif
#define	SIG_HOLD	(SIG_FUNC_TYP*)3

#define	SIGISDEFER(x)	(((int)(x) & 1) != 0)
#define	SIGUNDEFER(x)	(SIG_FUNC_TYP*)((int)(x) &~ 1)
#define	DEFERSIG(x)	(SIG_FUNC_TYP*)((int)(x) | 1)
