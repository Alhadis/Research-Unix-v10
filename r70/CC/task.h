...
/* o_type() */
typedef enum { OBJECT, TIMER, TASK, QHEAD, QTAIL } objtype;

/* sched::s_state */
typedef enum { IDLE=1, RUNNING=2, TERMINATED=4 } statetype;

/* type of stack, task::t_mode */
typedef enum { DEDICATED=1, SHARED=2 } modetype;
...
public:
	static void _print_error(int n);
...
/* qh_modes */
typedef enum { EMODE, WMODE, ZMODE } qmodetype;
